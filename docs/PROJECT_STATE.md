...
## Data (S3 Parquet)
- options: s3://opt-data-staging-project/parquet/options/ (35,408,466 rows)
- stocks: s3://opt-data-staging-project/parquet/stocks/ (403,730 rows)
- optionstats: s3://opt-data-staging-project/parquet/optionstats/ (407,899 rows)
